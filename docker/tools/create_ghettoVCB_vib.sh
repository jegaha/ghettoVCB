...
# Modification by jegaha
# These parameters can be predefined e.g. in a docker environment
GVCB_REPO=${GVCB_REPO:=https://github.com/lamw/ghettoVCB.git}
GVCB_REPO_DIR=${GVCB_REPO_DIR:=ghettoVCB}
GVCB_VIB_VERSION=${GVCB_VIB_VERSION:='1.0.0-0.0.0'}
...
<vib version="5.0">
  <type>bootbank</type>
  <name>ghettoVCB</name>
  <version>${GVCB_VIB_VERSION}</version>
